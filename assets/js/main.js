...
(function() {
  ...
  document.getElementById('myForm').addEventListener('submit', function(e) {
    ...
    // Create FormData object to easily collect all form inputs
    const formData = new FormData(form);
    
    // Use Fetch API to send form data to Formspree endpoint
    fetch(form.action, {
    ...
    .then(response => {
      ...
      if (response.ok) {
        // Show success message by changing display style
